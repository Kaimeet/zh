...
export let commands = {
  ...
  cm =;> deleteNearSelection(cm, range => ({
  ...
  cm =;> cm.extendSelectionsBy(range => lineStartSmart(cm, range.head),
    {origin: "+move", bias: 1};
  ),
  cm =;> cm.extendSelectionsBy(range => lineEnd(cm, range.head.line),
    {origin: "+move", bias: -1};
  ),
  cm =;> cm.extendSelectionsBy(range => {
