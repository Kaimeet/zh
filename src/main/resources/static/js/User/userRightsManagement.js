    ...
    flow.load({
        ...
        ,done : function(page, next) { //执行下一页的回调
            ...
            setTimeout(function(){
                ...
                $.get('../UserController/getUserRightsManagementList', json, function(res){
                    ...
                    layui.each(obj.date, function(index, item){
                        ...
                        if($("#bwType").val()==0){//电脑版
                            ...
                            str += '<td class="vercenter text-center phoneinformation">'+item.meanus+'</td>';
                            str += '<td class="vercenter text-center phoneinformation">';
                            str += '<a style="cursor: pointer;" onclick="roleAssignments('+item.id+')">权限分配</a>' ;
                            str += '</td>';
                            str += '</tr>';
                        }else{
...
function roleAssignments(id){
    post("../UserController/assignPermissions",{id:id,backflag:1,type:1});//jinrru
