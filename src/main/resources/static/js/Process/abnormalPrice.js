    ...
    flow.load({
        ...
        ,done : function(page, next) { //执行下一页的回调
            ...
            setTimeout(function(){
                ...
                $.get('../ProcessController/getAbnormalPriceList', json, function(res){
                    ...
                    layui.each(obj.date, function(index, item){
                        ...
                        if($("#bwType").val()==0){//电脑版
                            ...
                            str += '<td class="vercenter text-center phoneinformation" >'+item.style+'</td>';
                            str += '<td class="vercenter text-center phoneinformation">'+item.mName+'</td>';
                            str += '<td class="vercenter text-center phoneinformation">'+item.mnumber+'</td>';
                            str += '<td class="vercenter text-center phoneinformation">'+item.mounth+'</td>';
                            str += '</tr>';
                        }
//                        else{
