    ...
    flow.load({
        ...
        ,done : function(page, next) { //执行下一页的回调
            ...
            setTimeout(function(){
                ...
                $.get('../ProcessController/getMaterialsPriceList', json, function(res){
                    ...
                    layui.each(obj.date, function(index, item){
                        ...
                        if($("#bwType").val()==0){//电脑版
                            ...
                            str += '<td class="vercenter text-center phoneinformation">'+item.materialName+'></td>';
                            str += '<td class="vercenter text-center phoneinformation" >'+item.materialCode+'</td>';
                            str += '<td class="vercenter text-center phoneinformation">'+item.year+'</td>';
                            str += '<td class="vercenter text-center phoneinformation">'+item.month+'</td>';
...
//新增bom
function addNew(){
    post("../CommonController/execlEditPage",{})
}