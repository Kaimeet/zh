    ...
    flow.load({
        ...
        ,done : function(page, next) { //执行下一页的回调
            ...
            setTimeout(function(){
                ...
                $.get('../ProcessController/getBaseList', json, function(res){//getBOMSeriesList
                    ...
                    layui.each(obj.date, function(index, item){
                        ...
                        if($("#bwType").val()==0){//电脑版
                            ...
                            str += '<a style="cursor: pointer;" onclick="choose(\''+item.baseCode+'\',\''+item.baseName+'\')">选择</a><br/>' ;
                            str += '</td>';
                            str += '</tr>';
                        }
                        lis.push(str);
...
//选择
function choose(baseCode,baseName){
    console.log("baseCode = "+baseCode);
    console.log("baseName = "+baseName);
    parent.$("#baseName").val(baseName);
    parent.$("#baseName").html(baseName);
    parent.$("#baseName").text(baseName);
    parent.$("#baseCode").val(baseCode);
    parent.$("#baseCode").html(baseCode);
    parent.$("#baseCode").text(baseCode);
    parent.$("#baseChooseFlag").val(1);
    console.log(parent.$("#baseChooseFlag").val());
