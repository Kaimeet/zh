    ...
    flow.load({
        ...
        ,done : function(page, next) { //执行下一页的回调
            ...
            setTimeout(function(){
                ...
                $.get('../ProcessController/getBomStyleList', json, function(res){
                    ...
                    layui.each(obj.date, function(index, item){
                        ...
                        if($("#bwType").val()==0){//电脑版
                            ...
                            str += '<td class="vercenter text-center phoneinformation"><input type="radio" name="ckitem" id="check'+item.id+'" value="'+item.styleName+'"></td>';
                            str += '<td class="vercenter text-center phoneinformation" id="title' + item.noticeCode + '">'+item.styleName+'</td>';
                            str += '<td class="vercenter text-center phoneinformation">'+item.styleCode+'</td>';
