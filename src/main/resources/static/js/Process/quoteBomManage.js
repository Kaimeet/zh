    ...
    flow.load({
        ...
        ,done : function(page, next) { //执行下一页的回调
            ...
            setTimeout(function(){
                ...
                $.get('../ProcessController/getQuoteBomManageList', json, function(res){
                    ...
                    layui.each(obj.date, function(index, item){
                        ...
                        if($("#bwType").val()==0){//电脑版
                            ...
                            str += '<td class="vercenter text-center phoneinformation">'+item.processCode+'</td>';
                            str += '<td class="vercenter text-center phoneinformation">'+item.salesman+'</td>';
                            ...
                            str += '<a style="cursor: pointer;" onclick="view(\''+item.quotationNumber+'\')">查看</a>';
                            str += '</td>';
                            str += '</tr>';
                        }
//                        else{
...
//新增
function view(){
    post("../ProcessController/quoteInquiry",{})
}
