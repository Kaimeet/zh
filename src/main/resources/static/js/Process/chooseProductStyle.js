    ...
    flow.load({
        ...
        ,done : function(page, next) { //执行下一页的回调
            ...
            setTimeout(function(){
                ...
                $.get('../ProcessController/getProductStyleList', json, function(res){
                    ...
                    layui.each(obj.date, function(index, item){
                        ...
                        if($("#bwType").val()==0){//电脑版
                            ...
                            str += '<td class="vercenter text-center phoneinformation"><input type="radio" name="ckitem"  value="'+item.pname+'"></td>';
                            str += '<td class="vercenter text-center phoneinformation" id="title' + item.noticeCode + '">'+item.pname+'</td>';
