...
function choose(){
    ...
    parent.$("#bomname").val($("#Name"+productid).text());
    parent.$("#bomname").text($("#Name"+productid).text());
    parent.$("#bomname").html($("#Name"+productid).text());
    parent.$("#bomname").value=$("#Name"+productid).text();
  //  parent.$("#bomname").text(productid);
   // parent.$("#bomname").val(productid);
  //  parent.$("#bomname").value=productid;
   // parent.$("#bomname").html(productid);
    parent.$("#bomcode").val($("#Code"+productid).text());
    parent.$("#bomcode").text($("#Code"+productid).text());
    parent.$("#bomcode").html($("#Code"+productid).text());
    parent.$("#bomcode").value=$("#Code"+productid).text();
    //当你在iframe页面关闭自身时
