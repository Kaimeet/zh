...
// loading层
    ...
    var request = "../ProcessController/delProductCategoriesII";
    ajax = $.ajax({
        type : "POST",
...
function choose(){
    post("../ProcessController/saveProductCategoriesII",{});
}
...
function add(){
    parent.layer.open({
        type: 2,
        title: ['产品分类', 'font-size:18px;color:#788188;'],
        area : ['800px', '600px'],
        closeBtn: 1,
        content: '../ProcessController/addAndEditProductCategoriesTwo'
    });
}
//编辑
function edit1(id){
    parent.layer.open({
        ...
        area : ['800px', '600px'],
        closeBtn: 1,
        content: '../ProcessController/addAndEditProductCategoriesTwo?id='+id
    });
}
...
//新增
//function add(){
    //post("../ProcessController/addAndEditProductCategoriesTwo",{step:0})
//}
//编辑
//function edit1(id){
 //   console.log("id="+id);
  //  post("../ProcessController/addAndEditProductCategoriesTwo",{id:id})//草稿
//}