...
$(function() {
    ...
    $('#reportTable1').bootstrapTable({
        url:"../ProcessController/getbomType",
        method: 'get',
        cache: false,
        striped: true,
        pagination: true,
        ...
        columns: [
            ...
            {
                field:"bomSeries",title:"产品大类",align:"center",valign:"middle",sortable:"true",width : '10%',
                formatter : function(value, row, index) {
            ...
            {
             field:"bomType",title:"产品二级分类",align:"center",valign:"middle",sortable:"true",width : '10%',
             formatter : function(value, row, index) {
...
//返回
function back() {
    post("../ProcessController/bomType",{})
}
//下一步
function nextstep(){
    post("../ProcessController/bomType",{});//jinrru
}
//选择生产基地
function chooseBomSeries(){
    parent.layer.open({
        type: 2,
        title: ['产品大类名称', 'font-size:18px;color:#788188;'],
        area : ['800px', '600px'],
        closeBtn: 1,
        content: '../ProcessController/chooseBomType' //setBOMForProcess
    });
}
//选择账套
function chooseBomType(){
    parent.layer.open({
        type: 2,
        title: ['产品二类名称', 'font-size:18px;color:#788188;'],
        area : ['800px', '600px'],
        closeBtn: 1,
