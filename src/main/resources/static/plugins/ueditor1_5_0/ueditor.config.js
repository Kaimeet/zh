...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: "./plugins/ueditor1_5_0/config.json"
        ...
        ,initialStyle:'p{font-size:14px;font-family:Microsoft YaHei,sans-serif;}'//编辑器层级的基数,可以用来改变字体等
        ...
        ,'filterTxtRules' : function(){
            ...
            return {
                ...
                'span' : function(node) {
                   if(node.getAttr('class') == 'replacer_label'){
                        return true;
                    }else{
