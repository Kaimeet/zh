...
//    public static String errorCode="0";
     ...
     * 统一返回成功的DTO 带数据
     */
    public static <T>Dto<T> returnSuccess(String message,Object data,String errorCode){
        Dto dto=new Dto();
        dto.setSuccess(success);
        dto.setMsg(message);
     ...
     * 统一返回成功的DTO 带数据 没有消息
     */
    public static Dto returnDataSuccess(Object data,String errorCode){
        Dto dto=new Dto();
        dto.setSuccess(success);
        dto.setErrorCode(errorCode);
        dto.setData(data);
